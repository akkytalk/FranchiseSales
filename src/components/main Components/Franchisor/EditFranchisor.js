...
function EditFranchisor(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    ...
    props.onUpdateFranchisorData(data, user, toggle);
    setSubmitting(true);
  };
  ...
  return (
    <div>
      ...
      <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
        <ModalHeader toggle={toggle}>Edit Franchiser</ModalHeader>
        <ModalBody>
          <Formik
            initialValues={{
                    ...
                    <FormGroup>
                      {props?.data?.doc_1 == "nofile.pdf" ? (
                        ...
                        <InputGroup>
                          <a
                            target={"_blank"}
                            href={`https://uditsolutions.in/franchise/storage/app/public/Franchisers/${props.data?.doc_1}`}
                          >
                            {props.data?.doc_1}
                          </a>
                          <input
                    ...
                    <FormGroup>
                      {props?.data?.doc_2 == "nofile.pdf" ? (
                        ...
                        <InputGroup>
                          <a
                            target={"_blank"}
                            href={`https://uditsolutions.in/franchise/storage/app/public/Franchisers/${props.data?.doc_2}`}
                          >
                            {props.data?.doc_2}
                          </a>
                          <input
...
export default connect(mapStateToProps, mapDispatchToProps)(EditFranchisor);
