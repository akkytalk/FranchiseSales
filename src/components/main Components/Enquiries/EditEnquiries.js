  ...
  return (
    <div>
      ...
      <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
        <ModalHeader toggle={toggle}>Edit Enquiries</ModalHeader>
        <ModalBody>
          <Formik
            initialValues={{
...
export default connect(mapStateToProps, mapDispatchToProps)(EditEnquiries);
