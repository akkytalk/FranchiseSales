...
function Offer(props) {
  ...
  const handleSubmit = (values, { setSubmitting }) => {
    console.log("values in Offer:", values);
    ...
    console.log("Data of Offer:", user);
    props.onPostOfferData(data, user, toggle);
    setSubmitting(true);
    return;
  };
    ...
    <Card>
      <CardHeader className="bg-warning text-white">
        ...
        <Modal className="modal-info modal-lg" isOpen={modal} toggle={toggle}>
          <ModalHeader toggle={toggle}>Add New Offer</ModalHeader>
          <ModalBody>
            <Formik
              initialValues={{
                first_name: "",
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if (
                              ...
                              props.onDeleteOffer(data, user.id);
                          }}
                        >
                          <i
...
const mapDispatchToProps = (dispatch) => {
  return {
    onOfferGetData: (data) => dispatch(actions.offerGetData(data)),
    onDeleteOffer: (data, id) => dispatch(actions.deleteOffer(data, id)),
    onPostOfferData: (data, user, toggle) =>
      dispatch(actions.postOfferData(data, user, toggle)),
    onUpdateOfferData: (data, id) =>
      dispatch(actions.updateOfferData(data, id)),
    onEditOfferRow: (
      data,
      id,
      editing,
